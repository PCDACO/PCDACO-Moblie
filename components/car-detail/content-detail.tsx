...
const ContentDetail = () => {
  ...
  return (
    <View className="gap-8 bg-background p-4">
      <View>
        <Text className="text-xl font-semibold">Mô Tả</Text>
        <Text>
      ...
      <View>
        <Text className="text-xl font-semibold">Các tiện nghi khác</Text>
        <FlatList
          data={features}
          renderItem={({ item }) => (
      ...
      <View>
        <Text className="text-xl font-semibold">Điều khoản</Text>
